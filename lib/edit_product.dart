...
class _EditProductState extends State<EditProduct> {
  ...
  TextEditingController _stock = TextEditingController(text: editproductstock);
  TextEditingController _price = TextEditingController(text: editproductprice);
  String image = editproductimage;
  String _id = editproductid;
  ...
  Future<void> editProduct(String name, String stock, String price) async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(server + "update_product.php"),
      );
